...
{
	/* static: ~115KB combined, far too large for the kernel stack.
	 * Called once per frame and not reentrant, so static is safe. */
...
{
	/* static: 320*200 = 62.5KB, far too large for the kernel stack */
