...
void kernel_main(void) {
    ...
    terminal_writestring("                                DragonOS v0.2.0                                 \n");
    terminal_writestring("================================================================================\n\n");

    terminal_setcolor(vga_entry_color(VGA_COLOR_LIGHT_CYAN, VGA_COLOR_BLACK));
    terminal_writestring("[OK] Global Descriptor Table (GDT) initialized.\n");
    terminal_writestring("[OK] Interrupt Descriptor Table (IDT) loaded.\n");
    ...
    terminal_writestring("Welcome to DragonOS, a secure, monolithic 32-bit x86 kernel.\n");
    terminal_writestring("Type 'help' to see the list of available commands.\n\n");

    /* Send boot notification to serial log */
    print_serial("[DragonOS] Boot finished. Launching shell...\n");
